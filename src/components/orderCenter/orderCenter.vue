<template>
  <div>
    ...
    <form ref="authForm2" id="authForm2" action="https://ct.ctrip.com/m/SingleSignOn/H5SignInfo?opentype=iframe" method="post" target="_self">
    ...
    data() {
      return {
        ...
        user: {
          ...
          userId: '152116',
          endorsementID: '',
          XCflag: 'MyOrder',   // 初始化跳转到那个页面
          YXflag: 'myticket'   // 初始化跳转到那个页面
        }
      };
    },
    created() {
      ...
      localStorage.setItem('travel-YX-flag', 'myticket');
      localStorage.setItem('travel-XC-flag', 'MyOrder');
